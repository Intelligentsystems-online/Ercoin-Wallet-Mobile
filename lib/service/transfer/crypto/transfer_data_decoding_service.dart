...
class TransferDataDecodingService
{
  ...
  Address obtainToAddress(Uint8List transferBytes) => Address.ofBytes(_obtainToAddressBytes(transferBytes));
  ...
  Address obtainFromAddress(Uint8List transferBytes, int messageLength) =>
      Address.ofBytes(_obtainFromAddressBytes(transferBytes, messageLength));
