...
class _AccountDetailsRouteState extends State<AccountDetailsRoute> {
  ...
  Widget _notRegisteredWarning() => Row(
    children: const <Widget>[
      ...
      const SizedBox(width: 8.0),
      const Text("Not registered", style: const TextStyle(color: Colors.red, fontWeight: FontWeight.bold),
      ),
    ],
  );
  ...
  Widget _deleteBtn() => RaisedButton.icon(
    color: Colors.red,
  ...
  Widget _activationBtn(LocalAccountActivationDetails details) => RaisedButton(
